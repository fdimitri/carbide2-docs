...
| Realtime worker | `carbide2-worker` | `cs/cmd` WS protocol, fanout, PTY orchestration, VFS watcher/flusher | Control-plane provisioning logic |
...
| Change file-tree/VFS behavior | `worker/fs_store.rb`, `app/models/directory_entry.rb`, `app/models/file_change.rb` |
