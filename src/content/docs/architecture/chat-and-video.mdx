...
1. Formalized signaling contract page under API reference.
2. Explicit reconnection policy for in-flight `rtc/*` messages.
3. Security-level gating per `rtc/*` command (see [Security Model](/architecture/security-model/)).
